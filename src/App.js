  ...
  if (authLoading || dataLoading) {
    return (
      ...
      >
        <svg
          height="64"
          viewBox="0 0 147.73 133.36"
          xmlns="http://www.w3.org/2000/svg"
          style={{ animation: 'pulse 1.5s ease-in-out infinite' }}
        >
          <path
            fill="#f4ba15"
            d="M24.64,76.31L0,1.85h21.67l13.89,47.6h.37L49.83,1.85h19.82l-24.64,74.46v55.2h-20.38v-55.2Z"
          />
          <path
            fill="#f4ba15"
  ...
  <div style={{
    ...
    />
      ...
      {!dataLoading && (
        <>
          {view === 'dashboard' && (
            <DashboardView projects={projects} setView={setView} />
          )}
